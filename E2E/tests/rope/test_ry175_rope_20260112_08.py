...
t = 60
item = 'rope'
startTime =       '20260112_151820'
startsportTime =  '20260112_151900'
endTime =         '20260112_152030'
...
class TestUpdateRtspSettings(object):
    ...
    def test_updateRtspSettings(self, env, inputs, requests, expectation, case, e2e_time_helper):
        ...
        with allure.step(case):
            ...
            inputs['json']['startTimeRY'] = startTime
            inputs['json']['endTimeRY'] = endTime
