...
count = 7
item = 'rope'
startTime =       '20251113t092550z'
startsportTime =  '20251113t092400z'
endTime =         '20251113t092720z'
...
class TestUpdateRtspSettings(object):
    ...
    @allure.title("APP操作｜截图")
    def test_click_start_button(self, e2e_device_manager, project_root):
        dev, width, height = e2e_device_manager.connect_device()
        e2e_device_manager.take_screenshot(project_root, prefix="app_screenshot")
