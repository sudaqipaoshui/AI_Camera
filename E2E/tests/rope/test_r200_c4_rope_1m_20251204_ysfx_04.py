...
t = 60
item = 'rope'
startTime =       '20251204t142455z'
startsportTime =  '20251204t142500z'
endTime =         '20251204t142630z'
...
class TestUpdateRtspSettings(object):
    ...
    @pytest.mark.datafile('E2E/data/test_updateRtspSettings_200_channel4.yaml')
