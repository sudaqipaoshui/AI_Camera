...
t = 60
item = 'rope'
startTime =       '20251211t114100z'
startsportTime =  '20251211t114100z'
endTime =         '20251211t114500z'
...
class TestUpdateRtspSettings(object):
    ...
    @pytest.mark.datafile('E2E/data/test_updateRtspSettings_65_channel5.yaml')
