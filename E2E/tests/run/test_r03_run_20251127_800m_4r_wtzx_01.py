...
startTime = '20251127t142300z'
startsportTime = '20251127t142700z'
endTime = '20251127t142930z'
...
class TestUpdateRtspSettings(object):
    ...
    @pytest.mark.datafile('E2E/data/test_updateRtspSettings_type_channel4-5.yaml')
