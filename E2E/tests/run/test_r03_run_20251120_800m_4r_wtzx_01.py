...
startTime = '20251120t133000z'
startsportTime = '20251120t133700z'
endTime = '20251120t1342100z'
...
class TestUpdateRtspSettings(object):
    ...
    @pytest.mark.datafile('E2E/data/test_updateRtspSettings_type_channel4-2.yaml')
