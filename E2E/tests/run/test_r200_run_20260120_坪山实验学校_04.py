...
startTime = '20260120t141930z'
startsportTime = '20260120t142400z'
endTime = '20260120t143350z'
...
class TestUpdateRtspSettings(object):
    ...
    @pytest.mark.datafile('E2E/data/test_updateRtspSettings_200_channel4-3.yaml')
