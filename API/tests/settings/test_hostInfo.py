...
@allure.feature("camera-hostInfo")
@allure.story("hostInfo")
...
class TestHostInfo(object):
    ...
    @allure.title("{case}")
    @pytest.mark.datafile("API/data/settings/test_hostInfo.yaml")
    def test_hostInfo(self, env, inputs, requests, expectation, case, mysql):
