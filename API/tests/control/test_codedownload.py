...
@Doc: https://yapi.dream-sports.cn/project/423/interface/api/20053
"""
...
class TestCodedownload(object):
    ...
    @allure.title("{case}")
    @allure.link("https://yapi.dream-sports.cn/project/423/interface/api/20053")
    @pytest.mark.author('pytest.generator')
    @pytest.mark.datafile('API/data/control/test_codedownload.yaml')
    def test_codedownload(self, env, inputs, requests, expectation, case):
