...
@Doc: https://yapi.dream-sports.cn/project/423/interface/api/17316
"""
...
class TestUpdate(object):
    ...
    @allure.title("{case}")
    @allure.link("https://yapi.dream-sports.cn/project/423/interface/api/17316")
    @pytest.mark.author('pytest.generator')
    @pytest.mark.datafile('API/data/control/test_update.yaml')
    def test_update(self, env, inputs, requests, expectation, case):
