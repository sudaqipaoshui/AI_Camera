...
@Doc: https://yapi.dream-sports.cn/project/423/interface/api/20051
"""
...
class TestGetcodepackageinfo(object):
    ...
    @allure.title("{case}")
    @allure.link("https://yapi.dream-sports.cn/project/423/interface/api/20051")
    @pytest.mark.author('pytest.generator')
    @pytest.mark.datafile('API/data/control/test_getcodepackageinfo.yaml')
    def test_getcodepackageinfo(self, env, inputs, requests, expectation, case):
