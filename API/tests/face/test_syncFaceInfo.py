...
@allure.feature('camera-syncFaceInfo')
@allure.story('syncFaceInfo')
...
class TestSyncFaceInfo(object):
    ...
    @allure.title("{case}")
    @pytest.mark.datafile('API/data/face/test_syncFaceInfo.yaml')
    def test_syncFaceInfo(self, env, inputs, requests, expectation, case, mysql):
