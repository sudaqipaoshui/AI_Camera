...
@allure.feature("guestMode")
@allure.story("test_guestMode")
# @pytest.mark.flaky(reruns=2, reruns_delay=5)
class TestGuestMode(object):
    @pytest.fixture(scope="class", autouse=True)
    def prepare(self, request, env, mysql, requests):
        pass

    @allure.title("{case}")
    @pytest.mark.datafile("API/data/face/test_guestMode.yaml")
    def test_guestMode(self, env, inputs, requests, expectation, case, mysql):
