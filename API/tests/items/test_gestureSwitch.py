...
@allure.feature("camera-test_gestureSwitch")
@allure.story("test_gestureSwitch")
# @pytest.mark.flaky(reruns=2, reruns_delay=5)
class TestGestureSwitch(object):
    @pytest.fixture(scope="class", autouse=True)
    def prepare(self, request, env, mysql, requests):
        pass

    @allure.title("{case}")
    @pytest.mark.datafile("API/data/items/test_gestureSwitch.yaml")
    def test_gestureSwitch(self, env, inputs, requests, expectation, case, mysql):
