...
@Doc: https://yapi.dream-sports.cn/project/423/interface/api/17365
"""
...
class TestStartitem(object):
    ...
    @allure.title("{case}")
    @allure.link("https://yapi.dream-sports.cn/project/423/interface/api/17365")
    @pytest.mark.author('pytest.generator')
    @pytest.mark.datafile('API/data/items/test_startitem.yaml')
    def test_startitem(self, env, inputs, requests, expectation, case):
