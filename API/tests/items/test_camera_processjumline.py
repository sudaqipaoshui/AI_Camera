...
@Doc: https://yapi.dream-sports.cn/project/423/interface/api/17442
"""
...
class TestCameraProcessjumline(object):
    ...
    @allure.title("{case}")
    @allure.link("https://yapi.dream-sports.cn/project/423/interface/api/17442")
    @pytest.mark.author('pytest.generator')
    @pytest.mark.datafile('API/data/items/test_camera_processjumline.yaml')
    def test_camera_processjumline(self, env, inputs, requests, expectation, case):
