...
@Doc: https://yapi.dream-sports.cn/project/423/interface/api/17383
"""
...
class TestCameraChangeexercisemodel(object):
    ...
    @allure.title("{case}")
    @allure.link("https://yapi.dream-sports.cn/project/423/interface/api/17383")
    @pytest.mark.author('pytest.generator')
    @pytest.mark.datafile('API/data/items/test_camera_changeexercisemodel.yaml')
    def test_camera_changeexercisemodel(self, env, inputs, requests, expectation, case):
