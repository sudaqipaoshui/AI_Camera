...
@Doc: https://yapi.dream-sports.cn/project/423/interface/api/17345
"""
...
class TestCameraJoinSport(object):
    ...
    @allure.title("终点摄像头——开始运动")
    @allure.link("https://yapi.dream-sports.cn/project/423/interface/api/17345")
    @pytest.mark.author('pytest.generator')
    @pytest.mark.datafile('API/data/items/test_camera_joinSport.yaml')
    def test_camera_joinSport(self, env, inputs, requests, expectation, case):
