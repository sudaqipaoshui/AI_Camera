...
@allure.feature('camera-test_changeResolution')
@allure.story('test_changeResolution')
...
class TestChangeResolution(object):
    ...
    @allure.title("{case}")
    @pytest.mark.datafile('API/data/rtsp/test_changeResolution.yaml')
    def test_changeResolution(self, env, inputs, requests, expectation, case, mysql):
