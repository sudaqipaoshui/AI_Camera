...
@allure.feature('camera-test_updateRtspSettings')
@allure.story('test_updateRtspSettings')
...
class TestUpdateRtspSettings(object):
    ...
    @allure.title("{case}")
    @pytest.mark.manual
    @pytest.mark.datafile('API/data/rtsp/test_updateRtspSettings_type5.yaml')
